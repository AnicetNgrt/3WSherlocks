defmodule Fakebusters.AccountsTest do
  use Fakebusters.DataCase

  alias Fakebusters.Accounts
  import Fakebusters.AccountsFixtures
  alias Fakebusters.Accounts.{User, UserToken}
  ...
  describe "user_favorite_topics" do
    ...
    def user_favorite_topic_fixture(attrs \\ %{}) do
      {:ok, user_favorite_topic} =
        attrs
        |> Enum.into(@valid_attrs)
        |> Accounts.create_user_favorite_topic()

      user_favorite_topic
    end

    test "list_user_favorite_topics/0 returns all user_favorite_topics" do
      user_favorite_topic = user_favorite_topic_fixture()
      assert Accounts.list_user_favorite_topics() == [user_favorite_topic]
    end

    test "get_user_favorite_topic!/1 returns the user_favorite_topic with given id" do
      user_favorite_topic = user_favorite_topic_fixture()
      assert Accounts.get_user_favorite_topic!(user_favorite_topic.id) == user_favorite_topic
    end
    ...
    #   assert {:error, %Ecto.Changeset{}} = Accounts.create_user_favorite_topic(@invalid_attrs)
    # end
    ...
    #   user_favorite_topic = user_favorite_topic_fixture()
    #   assert {:error, %Ecto.Changeset{}} = Accounts.update_user_favorite_topic(user_favorite_topic, @invalid_attrs)
    #   assert user_favorite_topic == Accounts.get_user_favorite_topic!(user_favorite_topic.id)
    # end
    ...
    test "change_user_favorite_topic/1 returns a user_favorite_topic changeset" do
      user_favorite_topic = user_favorite_topic_fixture()
      assert %Ecto.Changeset{} = Accounts.change_user_favorite_topic(user_favorite_topic)
    end
  end
end
