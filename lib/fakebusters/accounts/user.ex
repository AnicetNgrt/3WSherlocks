defmodule Fakebusters.Accounts.User do
  @moduledoc """
  User account schema and validation rules.
  """
  ...
  defp is_valid_emoji?(value) when is_binary(value) do
  ...
  defp is_valid_emoji?(_), do: false
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Fakebusters.Repo)
  ...
  """
  def valid_password?(%Fakebusters.Accounts.User{hashed_password: hashed_password}, password)
