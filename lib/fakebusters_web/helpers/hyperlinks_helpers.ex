defmodule FakebustersWeb.HyperlinksHelpers do
  ...
  @known_top_level_domains [
    ...
    ".americanexpress", ".americanfamily", ".amex", ".amfam", ".amica", ".amsterdam", ".an", ".analytics",
    ".android", ".anquan", ".anz", ".ao", ".aol", ".apartments", ".app", ".apple", ".aq", ".aquarelle", ".ar",
    ".arab", ".aramco", ".archi", ".army", ".arpa", ".art", ".arte", ".as", ".asda", ".asia", ".associates",
    ".at", ".athleta", ".attorney", ".au", ".auction", ".audi", ".audible", ".audio", ".auspost", ".author",
    ".auto", ".autos", ".avianca", ".aw", ".aws", ".ax", ".axa", ".az", ".azure", ".ba", ".baby", ".baidu",
    ...
    ".bio", ".biz", ".bj", ".bl", ".black", ".blackfriday", ".blanco", ".blockbuster", ".blog", ".bloomberg",
    ".blue", ".bm", ".bms", ".bmw", ".bn", ".bnl", ".bnpparibas", ".bo", ".boats", ".boehringer", ".bofa",
    ".bom", ".bond", ".boo", ".book", ".booking", ".boots", ".bosch", ".bostik", ".boston", ".bot", ".boutique",
    ".box", ".bq", ".br", ".bradesco", ".bridgestone", ".broadway", ".broker", ".brother", ".brussels", ".bs",
    ".bt", ".budapest", ".bugatti", ".build", ".builders", ".business", ".buy", ".buzz", ".bv", ".bw", ".by",
    ...
    ".career", ".careers", ".cars", ".cartier", ".casa", ".case", ".caseih", ".cash", ".casino", ".cat",
    ".catering", ".catholic", ".cba", ".cbn", ".cbre", ".cbs", ".cc", ".cd", ".ceb", ".center", ".ceo", ".cern",
    ".cf", ".cfa", ".cfd", ".cg", ".ch", ".chanel", ".channel", ".charity", ".chase", ".chat", ".cheap",
    ...
    ".cr", ".credit", ".creditcard", ".creditunion", ".cricket", ".crown", ".crs", ".cruise", ".cruises", ".csc",
    ...
    ".esurance", ".et", ".etisalat", ".eu", ".eurovision", ".eus", ".events", ".everbank", ".exchange",
    ...
    ".gb", ".gbiz", ".gd", ".gdn", ".ge", ".gea", ".gent", ".genting", ".george", ".gf", ".gg", ".ggee", ".gh",
    ".gi", ".gift", ".gifts", ".gives", ".giving", ".gl", ".glade", ".glass", ".gle", ".global", ".globo", ".gm",
    ".gmail", ".gmbh", ".gmo", ".gmx", ".gn", ".godaddy", ".gold", ".goldpoint", ".golf", ".goo", ".goodhands",
    ...
    ".intel", ".international", ".intuit", ".investments", ".io", ".ipiranga", ".iq", ".ir", ".irish", ".is",
    ...
    ".kpn", ".kr", ".krd", ".kred", ".kuokgroup", ".kw", ".ky", ".kyoto", ".kz", ".la", ".lacaixa", ".ladbrokes",
    ...
    ".living", ".lixil", ".lk", ".llc", ".loan", ".loans", ".locker", ".locus", ".loft", ".lol", ".london",
    ".lotte", ".lotto", ".love", ".lpl", ".lplfinancial", ".lr", ".ls", ".lt", ".ltd", ".ltda", ".lu",
    ".lundbeck", ".lupin", ".luxe", ".luxury", ".lv", ".ly", ".ma", ".macys", ".madrid", ".maif", ".maison",
    ...
    ".media", ".meet", ".melbourne", ".meme", ".memorial", ".men", ".menu", ".meo", ".merckmsd", ".metlife",
    ".mf", ".mg", ".mh", ".miami", ".microsoft", ".mil", ".mini", ".mint", ".mit", ".mitsubishi", ".mk", ".ml",
    ".mlb", ".mls", ".mm", ".mma", ".mn", ".mo", ".mobi", ".mobile", ".mobily", ".moda", ".moe", ".moi", ".mom",
    ".monash", ".money", ".monster", ".montblanc", ".mopar", ".mormon", ".mortgage", ".moscow", ".moto",
    ".motorcycles", ".mov", ".movie", ".movistar", ".mp", ".mq", ".mr", ".ms", ".msd", ".mt", ".mtn", ".mtpc",
    ".mtr", ".mu", ".museum", ".mutual", ".mutuelle", ".mv", ".mw", ".mx", ".my", ".mz", ".na", ".nab", ".nadex",
    ...
    ".nfl", ".ng", ".ngo", ".nhk", ".ni", ".nico", ".nike", ".nikon", ".ninja", ".nissan", ".nissay", ".nl",
    ...
    ".oracle", ".orange", ".org", ".organic", ".orientexpress", ".origins", ".osaka", ".otsuka", ".ott", ".ovh",
    ".pa", ".page", ".pamperedchef", ".panasonic", ".panerai", ".paris", ".pars", ".partners", ".parts", ".party",
    ...
    ".qpon", ".quebec", ".quest", ".qvc", ".racing", ".radio", ".raid", ".re", ".read", ".realestate",
    ...
    ".restaurant", ".review", ".reviews", ".rexroth", ".rich", ".richardli", ".ricoh", ".rightathome", ".ril",
    ".rio", ".rip", ".rmit", ".ro", ".rocher", ".rocks", ".rodeo", ".rogers", ".room", ".rs", ".rsvp", ".ru",
    ".rugby", ".ruhr", ".run", ".rw", ".rwe", ".ryukyu", ".sa", ".saarland", ".safe", ".safety", ".sakura",
    ".sale", ".salon", ".samsclub", ".samsung", ".sandvik", ".sandvikcoromant", ".sanofi", ".sap", ".sapo",
    ".sarl", ".sas", ".save", ".saxo", ".sb", ".sbi", ".sbs", ".sc", ".sca", ".scb", ".schaeffler", ".schmidt",
    ".scholarships", ".school", ".schule", ".schwarz", ".science", ".scjohnson", ".scor", ".scot", ".sd",
    ".se", ".search", ".seat", ".secure", ".security", ".seek", ".select", ".sener", ".services", ".ses",
    ...
    ".toyota", ".toys", ".tp", ".tr", ".trade", ".trading", ".training", ".travel", ".travelchannel",
    ".travelers", ".travelersinsurance", ".trust", ".trv", ".tt", ".tube", ".tui", ".tunes", ".tushu", ".tv",
    ".tvs", ".tw", ".tz", ".ua", ".ubank", ".ubs", ".uconnect", ".ug", ".uk", ".um", ".unicom", ".university",
    ".uno", ".uol", ".ups", ".us", ".uy", ".uz", ".va", ".vacations", ".vana", ".vanguard", ".vc", ".ve",
    ".vegas", ".ventures", ".verisign", ".versicherung", ".vet", ".vg", ".vi", ".viajes", ".video", ".vig",
    ".viking", ".villas", ".vin", ".vip", ".virgin", ".visa", ".vision", ".vista", ".vistaprint", ".viva",
    ".vivo", ".vlaanderen", ".vn", ".vodka", ".volkswagen", ".volvo", ".vote", ".voting", ".voto", ".voyage",
    ...
    ".xerox", ".xfinity", ".xihuan", ".xin", ".测试", ".कॉम", ".परीक्षा", ".セール", ".佛山", ".ಭಾರತ", ".慈善",
    ".集团", ".在线", ".한국", ".ଭାରତ", ".大众汽车", ".点看", ".คอม", ".ভাৰত", ".ভারত", ".八卦", ".‏موقع‎", ".বাংলা",
    ".公益", ".公司", ".香格里拉", ".网站", ".移动", ".我爱你", ".москва", ".испытание", ".қаз", ".католик",
    ".онлайн", ".сайт", ".联通", ".срб", ".бг", ".бел", ".‏קום‎", ".时尚", ".微博", ".테스트", ".淡马锡",
    ".ファッション", ".орг", ".नेट", ".ストア", ".삼성", ".சிங்கப்பூர்", ".商标", ".商店", ".商城", ".дети",
    ".мкд", ".‏טעסט‎", ".ею", ".ポイント", ".新闻", ".工行", ".家電", ".‏كوم‎", ".中文网", ".中信", ".中国", ".中國",
    ".娱乐", ".谷歌", ".భారత్", ".ලංකා", ".電訊盈科", ".购物", ".測試", ".クラウド", ".ભારત", ".通販", ".भारतम्",
    ".भारत", ".भारोत", ".‏آزمایشی‎", ".பரிட்சை", ".网店", ".संगठन", ".餐厅", ".网络", ".ком", ".укр", ".香港",
    ".诺基亚", ".食品", ".δοκιμή", ".飞利浦", ".‏إختبار‎", ".台湾", ".台灣", ".手表", ".手机", ".мон", ".‏الجزائر‎",
    ".‏عمان‎", ".‏ارامكو‎", ".‏ایران‎", ".‏العليان‎", ".‏اتصالات‎", ".‏امارات‎", ".‏بازار‎", ".‏موريتانيا‎", ".‏پاکستان‎", ".‏الاردن‎",
    ".‏موبايلي‎", ".‏بارت‎", ".‏بھارت‎", ".‏المغرب‎", ".‏ابوظبي‎", ".‏السعودية‎", ".‏ڀارت‎", ".‏كاثوليك‎", ".‏سودان‎", ".‏همراه‎",
    ".‏عراق‎", ".‏مليسيا‎", ".澳門", ".닷컴", ".政府", ".‏شبكة‎", ".‏بيتك‎", ".‏عرب‎", ".გე", ".机构", ".组织机构", ".健康",
    ".ไทย", ".‏سورية‎", ".招聘", ".рус", ".рф", ".珠宝", ".‏تونس‎", ".大拿", ".みんな", ".グーグル", ".ελ", ".世界",
    ".書籍", ".ഭാരതം", ".ਭਾਰਤ", ".网址", ".닷넷", ".コム", ".天主教", ".游戏", ".vermögensberater",
